        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4">
            <h4 className="font-medium text-amber-900 dark:text-amber-200 mb-2">
              💡 Comment utiliser ces emails :
            </h4>
            <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1">
              <li>• Cliquez sur "Copier tous les emails" ci-dessus</li>
              <li>• Ouvrez votre client email (Outlook, Gmail, etc.)</li>
              <li>• Collez dans le champ "À" ou "Cci" pour un envoi groupé</li>
              <li>• Rédigez vos consignes d'examen et envoyez</li>
            </ul>
          </div>
        </div>

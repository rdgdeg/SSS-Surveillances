-- Migration: Système de versioning complet
-- Créé le: 2025-01-01
...
ALTER TABLE version_snapshots ADD CONSTRAINT IF NOT EXISTS unique_table_record_version 
...
BEGIN
    ...
    -- Construire la requête de restauration dynamiquement
    SELECT ARRAY_AGG(key), ARRAY_AGG(quote_literal(value::TEXT))
    INTO v_fields, v_values
    FROM jsonb_each_text(v_version_data);
    
    -- Exécuter la restauration
    v_restore_sql := format(

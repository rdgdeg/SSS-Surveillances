-- Correction des triggers de versioning pour capturer correctement l'utilisateur

-- Fonction pour configurer les variables de session
...
-- Fonction améliorée pour enregistrer les versions
...
-- Fonction pour tester le versioning
...
-- Fonction pour diagnostiquer les problèmes de versioning
